...
namespace LanchesMax.Migrations
{
    ...
    [Migration("20230415020224_PedidoDetalhe")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LanchesMax.Models.CarrinhoCompraItem", b =>
                {
            ...
            modelBuilder.Entity("LanchesMax.Models.Categoria", b =>
                {
            ...
            modelBuilder.Entity("LanchesMax.Models.Lanche", b =>
                {
                    b.Property<int>("LancheId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LanchesMax.Models.Pedido", b =>
                {
            ...
            modelBuilder.Entity("LanchesMax.Models.PedidoDetalhe", b =>
                {
            ...
            modelBuilder.Entity("LanchesMax.Models.CarrinhoCompraItem", b =>
                {
                    b.HasOne("LanchesMax.Models.Lanche", "Lanche")
                        .WithMany()
            ...
            modelBuilder.Entity("LanchesMax.Models.Lanche", b =>
                {
                    b.HasOne("LanchesMax.Models.Categoria", "Categoria")
                        .WithMany("Lanches")
            ...
            modelBuilder.Entity("LanchesMax.Models.PedidoDetalhe", b =>
                {
                    ...
                    b.HasOne("LanchesMax.Models.Pedido", "Pedido")
